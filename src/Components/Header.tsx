...
// import "../Components/Images/RobonitoLogo.png";
import {
  createStyles,
  Container,
  Avatar,
    ...
    <div className={classes.header}>
      <Container className={classes.mainSection}>
        <Group position="apart">
          <a href='/'>
          <img  src="\Image\RobonitoLogo.png" alt='Robonito' style={{width:100}} />
          </a>
          ...
          >
            ...
            <Menu.Dropdown>
              ...
              <Menu.Item icon={<IconLogout size={14} stroke={1.5} />}><Button onClick={() => login("/")}>Logout</Button></Menu.Item>
